    ...
    <section class="newsletter">
        <div class="container">
            ...
            <div class="row content">
                <div class="col s12">
                    <div class="col s6">
                        Thank you for joining <?=$data['appName'];?>! To finish signing up, you just need to confirm that we got your email right.
                        <br />
                        <br />To confirm your email, please click this link:
                        <br /><br />
                        <a href="<?=Html::encode($data['confirmURL']);?>"><?=$data["confirmURL"];?></a>
                        <br />
