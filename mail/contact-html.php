...
<head>
<title>DynTechnologies Contact</title>
	...
	<section class="newsletter">
		<div class="container">
            <div class="row">
                ...
                <div class="col s12">
                    <h1 class="logo">DYN Technologies</h1>
                </div>
                <div class="col s12">
                    <h2>Site Contact</h2>
                </div>
            ...
            <div class="row banner">
                <div class="col s12">
                    <h1><?= Html::encode($data['name']) ?> - <?= Html::encode($data['email']) ?></h1>
                    <h3>Wrote on <?= date('d-m-Y h:i:s') ?>:</h3>
                </div>
            </div>
            <div class="row content">
                <div class="col s12">
                    <div class="col s6" style="text-align: left; word-wrap: break-word;">
